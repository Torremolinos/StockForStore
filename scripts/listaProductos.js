...
export const listaProductos = () => {
  ...
  const modal =
    document.querySelector(".modal"); /*Con querySelector seleccionamos modal.*/
  ...
  closeModal.addEventListener("click", () => {
    ...
    /* HE INTENTANDO CONTROLAR QUE NO ENTRADAN DATOS INCORRECTOS PERO ME CRUJE EL PROGRAMA Y NO SE QUE HACER
    LO DEJO AQUI COMENTADO PERO NO TENGO IDEA EN QUE FALLA*/
    // if (
    //   nuevoNombre === "" ||
    //   isNaN(nuevaCantidad) ||
    //   nuevaCantidad <= 0 ||
